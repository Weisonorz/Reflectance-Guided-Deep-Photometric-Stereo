...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_dir',    default='/data2/datasets/ruoguli/PS_Blobby_Dataset')
        self.parser.add_argument('--latent_vectors_dir', default='NPs-BRDF/latent_vectors')
        self.parser.add_argument('--data_dir2',   default='/data2/datasets/ruoguli/PS_Sculpture_Dataset')
